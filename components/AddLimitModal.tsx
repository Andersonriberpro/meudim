        ...
        <div className="space-y-4 md:space-y-6">
          ...
          <div className="flex flex-col-reverse md:flex-row md:space-x-3 pt-2 gap-2">
            ...
            <button
              ...
              className={`w-full md:flex-[2] py-4 rounded-xl font-black text-[#E6DCCB] transition-all shadow-xl active:scale-95 uppercase text-[9px] tracking-widest ${category && limitValue
